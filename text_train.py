...
validate_dataset = dataset.skip(5000).take(100).batch(BATCH_SIZE).prefetch(tf.data.AUTOTUNE)
test_dataset = dataset.skip(5100).batch(BATCH_SIZE).prefetch(tf.data.AUTOTUNE)
